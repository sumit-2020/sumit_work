...
\documentclass[oneside,a4paper,12pt,reqno,openbib]{memoir} %add 'draft' to turn draft option on (see below)
...
\newcommand*\expandedname{Twitter News Feed}
\newcommand*\shortname{TNF}
...
\appendix
\input{appendix1.tex} % filename in curly brackets
